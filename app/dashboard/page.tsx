...
import { getStats, getCategories, getRecentTransactions, getChartData, getBudgetStatus, addTransaction, deleteTransaction, updateTransaction } from "../db/actions/budget";
                  ...
                  <tbody className="divide-y divide-slate-50">
                    {lastTransactions.map((t) => (
                      <TransactionRow
                        key={t.id}
                        t={t}
                        onUpdate={async (id, newAmount) => {
                          "use server";
                          await updateTransaction(id, newAmount);
                        }}
                        onDelete={async (id) => {
                          "use server";
